...
DatePicker.defaults = (function( prefix ) {
    ...
    return {
        ...
        labelMonthSelect: 'انتخاب یک ماه',
            labelYearSelect: 'انتخاب یک سال',

        // Months and weekdays
        monthsFull: ['ژانوریه', 'فوریه', 'مارس', 'آپریل', 'مه', 'ژوئن', 'جولای', 'آگوست', 'سپتامبر', 'اکتبر', 'نوامبر', 'دسامبر'],
        monthsFull: ['ژانوریه', 'فوریه', 'مارس', 'آپریل', 'مه', 'ژوئن', 'جولای', 'آگوست', 'سپتامبر', 'اکتبر', 'نوامبر', 'دسامبر'],
        weekdaysFull: ['یکشنبه', 'دوشنبه', 'سه شنبه', 'چهارشنبه', 'پنج شنبه', 'جمعه', 'شنبه'],
        weekdaysShort: ['یکشنبه', 'دوشنبه', 'سه شنبه', 'چهارشنبه', 'پنج شنبه', 'جمعه', 'شنبه'],
