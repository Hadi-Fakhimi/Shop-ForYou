        ...
        return {
            ...
            inputTooLong: function (e) {
                var t = e.input.length - e.maximum,
                    e = "لطفا " + t + " کاراکتر را حذف کنید";
                return 1 != t && (e += "s"), e
            },
            inputTooShort: function (e) {
                return "لطفا " + (e.minimum - e.input.length) + " کاراکتر یا بیشتر وارد کنید"
            },
            loadingMore: function () {
                return "بارگزاری نتایج بیشتر ..."
            },
            maximumSelected: function (e) {
                var t = "شما فقط می توانید " + e.maximum + " مورد را انتخاب کنید";
            ...
            removeAllItems: function () {
                return "پاک کردن همه موارد"
            },
            removeItem: function () {
                return "پاک کردن مورد"
            },
            search: function () {
                return "جستجو"
            }
