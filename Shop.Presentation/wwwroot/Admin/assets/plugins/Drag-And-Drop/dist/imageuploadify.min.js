...
(function($, window, document, undefined) {
	...
	$.fn.imageuploadify = function(opts) {
		...
		this.each(function() {
			...
			let totalFiles = [];
			let counter = 0;
			let dragbox = $(`<div class="imageuploadify well"><div class="imageuploadify-overlay"><i class="fa fa-picture-o"></i></div><div class="imageuploadify-images-list text-center"><i class="bx bxs-cloud-upload"></i><span class='imageuploadify-message'>برای بارگزاری، فایل های خود را در اینجا بکشید و رها کنید</span><button type="button"class="btn btn-default">یا انتخاب فایل برای بارگزاری</button></div></div>`);
			...
			const readingFile = (id, file) => {
				...
				container.css("margin-right", marginSize + "px");
