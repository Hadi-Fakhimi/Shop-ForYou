! function (t, e) {
    function i(i, a) {
        this.currentView = 0, this.minDate, this.maxDate, this._attachedEvents = [], this.element = i, this.$element = t(i), this.params = {
            date: !0,
            time: !0,
            format: "YYYY-MM-DD",
            minDate: null,
            ...
            nowText: "حالا",
            switchOnClick: !1
        }, this.params = t.fn.extend(this.params, a), this.name = "dtp_" + this.setName(), this.$element.attr("data-dtp", this.name), e.locale(this.params.lang), this.init()
    }
    ...
    e.locale("en"), t.fn[a] = function (e, a) {
        ...
        init: function () {
            this.initDays(), this.initDates(), this.initTemplate(), this.initButtons(), this._attachEvent(t(window), "resize", this._centerBox.bind(this)), this._attachEvent(this.$dtpElement.find(".dtp-content"), "click", this._onElementClick.bind(this)), this._attachEvent(this.$dtpElement, "click", this._onBackgroundClick.bind(this)), this._attachEvent(this.$dtpElement.find(".dtp-close > a"), "click", this._onCloseClick.bind(this)), this._attachEvent(this.$element, "focus", this._onFocus.bind(this))
        },
        initDays: function () {
            this.days = [];
        ...
        initTemplate: function () {
            this.template = '<div class="dtp hidden" id="' + this.name + '"><div class="dtp-content"><div class="dtp-date-view"><header class="dtp-header"><div class="dtp-actual-day">Lundi</div><div class="dtp-close"><a href="javascript:void(0);"><i class="material-icons">clear</i></</div></header><div class="dtp-date hidden"><div><div class="left center p10"><a href="javascript:void(0);" class="dtp-select-month-before"><i class="material-icons">chevron_right</i></a></div><div class="dtp-actual-month p80">MAR</div><div class="right center p10"><a href="javascript:void(0);" class="dtp-select-month-after"><i class="material-icons">chevron_left</i></a></div><div class="clearfix"></div></div><div class="dtp-actual-num">13</div><div><div class="left center p10"><a href="javascript:void(0);" class="dtp-select-year-before"><i class="material-icons">chevron_right</i></a></div><div class="dtp-actual-year p80">2014</div><div class="right center p10"><a href="javascript:void(0);" class="dtp-select-year-after"><i class="material-icons">chevron_left</i></a></div><div class="clearfix"></div></div></div><div class="dtp-time hidden"><div class="dtp-actual-maxtime">23:55</div></div><div class="dtp-picker"><div class="dtp-picker-calendar"></div><div class="dtp-picker-datetime hidden"><div class="dtp-actual-meridien"><div class="left p20"><a class="dtp-meridien-am" href="javascript:void(0);">AM</a></div><div class="dtp-actual-time p60"></div><div class="right p20"><a class="dtp-meridien-pm" href="javascript:void(0);">PM</a></div><div class="clearfix"></div></div><div id="dtp-svg-clock"></div></div></div></div><div class="dtp-buttons"><button class="dtp-btn-now btn btn-flat hidden">' + this.params.nowText + '</button><button class="dtp-btn-clear btn btn-flat hidden">' + this.params.clearText + '</button><button class="dtp-btn-cancel btn btn-flat">' + this.params.cancelText + '</button><button class="dtp-btn-ok btn btn-flat">' + this.params.okText + '</button><div class="clearfix"></div></div></div></div>', t("body").find("#" + this.name).length <= 0 && (t("body").append(this.template), this && (this.dtpElement = t("body").find("#" + this.name)), this.$dtpElement = t(this.dtpElement))
        },
        ...
        initHours: function () {
            ...
            this.$dtpElement.find(".dtp-picker-datetime").removeClass("hidden"), this.$dtpElement.find(".dtp-picker-calendar").addClass("hidden");
            for (var e = this.createSVGClock(!0), i = 0; 12 > i; i++) {
                var a = -(162 * Math.sin(2 * -Math.PI * (i / 12))),
                    s = -(162 * Math.cos(2 * -Math.PI * (i / 12))),
                    n = this.currentDate.format(t) == i ? "#8BC34A" : "transparent",
                    r = this.currentDate.format(t) == i ? "#fff" : "#000",
                    h = this.createSVGElement("circle", {
                        id: "h-" + i,
                ...
                d.textContent = 0 === i && this.params.shortTime ? 12 : i, this.toggleTime(i, !0) ? (h.addEventListener("click", this._onSelectHour.bind(this)), d.addEventListener("click", this._onSelectHour.bind(this))) : (h.className += " disabled", d.className += " disabled", d.setAttribute("fill", "#bdbdbd")), e.appendChild(h), e.appendChild(d)
            }
            if (!this.params.shortTime) {
                for (var i = 0; 12 > i; i++) {
                    var a = -(110 * Math.sin(2 * -Math.PI * (i / 12))),
                        s = -(110 * Math.cos(2 * -Math.PI * (i / 12))),
                        n = this.currentDate.format(t) == i + 12 ? "#8BC34A" : "transparent",
                    ...
                    d.textContent = i + 12, this.toggleTime(i + 12, !0) ? (h.addEventListener("click", this._onSelectHour.bind(this)), d.addEventListener("click", this._onSelectHour.bind(this))) : (h.className += " disabled", d.className += " disabled", d.setAttribute("fill", "#bdbdbd")), e.appendChild(h), e.appendChild(d)
                }
        ...
        initMinutes: function () {
            ...
            for (var t = this.createSVGClock(!1), e = 0; 60 > e; e++) {
                var i = e % 5 === 0 ? 162 : 158,
                    a = e % 5 === 0 ? 30 : 20,
                    s = -(i * Math.sin(2 * -Math.PI * (e / 60))),
                    n = -(i * Math.cos(2 * -Math.PI * (e / 60))),
                    r = this.currentDate.format("m") == e ? "#8BC34A" : "transparent",
                    h = this.createSVGElement("circle", {
                        id: "m-" + e,
                ...
                this.toggleTime(e, !1) ? h.addEventListener("click", this._onSelectMinute.bind(this)) : h.className += " disabled", t.appendChild(h)
            }
            for (var e = 0; 60 > e; e++)
                if (e % 5 === 0) {
                    var s = -(162 * Math.sin(2 * -Math.PI * (e / 60))),
                    ...
                    d.textContent = e, this.toggleTime(e, !1) ? d.addEventListener("click", this._onSelectMinute.bind(this)) : (d.className += " disabled", d.setAttribute("fill", "#bdbdbd")), t.appendChild(d)
                } this._centerBox()
        },
        animateHands: function () {
            var t = this.currentDate.hour(),
                e = this.currentDate.minute(),
                i = this.$dtpElement.find(".hour-hand");
            i[0].setAttribute("transform", "rotate(" + 360 * t / 12 + ")");
            var a = this.$dtpElement.find(".minute-hand");
            a[0].setAttribute("transform", "rotate(" + 360 * e / 60 + ")")
        },
        createSVGClock: function (t) {
            var e = this.params.shortTime ? -120 : -90,
                ...
                n = this.createSVGElement("circle", {
                    r: "15",
                    fill: "#757575"
                });
            if (a.appendChild(s), t) {
                ...
                a.appendChild(r), a.appendChild(h)
            } else {
                var r = this.createSVGElement("line", {
                        "class": "minute-hand",
                        x1: 0,
                ...
                a.appendChild(h), a.appendChild(r)
            }
            return a.appendChild(n), i.appendChild(a), this.$dtpElement.find("#dtp-svg-clock").empty(), this.$dtpElement.find("#dtp-svg-clock")[0].appendChild(i), this.animateHands(), a
        },
        ...
        isAfterMinDate: function (t, i, a) {
            ...
            if ("undefined" != typeof this.minDate && null !== this.minDate) {
                var n = e(this.minDate),
                    r = e(t);
                i || a || (n.hour(0), n.minute(0), r.hour(0), r.minute(0)), n.second(0), r.second(0), n.millisecond(0), r.millisecond(0), a ? s = parseInt(r.format("X")) >= parseInt(n.format("X")) : (r.minute(0), n.minute(0), s = parseInt(r.format("X")) >= parseInt(n.format("X")))
            }
            return s
        },
        ...
        showTime: function (t) {
            if (t) {
                var e = t.minute(),
                    i = (this.params.shortTime ? t.format("hh") : t.format("HH")) + ":" + (2 == e.toString().length ? e : "0" + e) + (this.params.shortTime ? " " + t.format("A") : "");
        ...
        generateCalendar: function (t) {
            ...
            if (null !== t) {
                ...
                for (var r = a.date(); r <= s.date(); r++) {
                    if (r === a.date()) {
                        var h = i.week.indexOf(n.toString());
                        if (h > 0)
                            for (var d = 0; h > d; d++) i.days.push(0)
                    }
        ...
        setElementValue: function () {
            this.$element.trigger("beforeChange", this.currentDate), "undefined" != typeof t.material && this.$element.removeClass("empty"), this.$element.val(e(this.currentDate).locale(this.params.lang).format(this.params.format)), this.$element.trigger("change", this.currentDate)
        },
        ...
        toggleTime: function (t, i) {
            var a = !1;
            if (i) {
                var s = e(this.currentDate);
                s.hour(this.convertHours(t)).minute(0).second(0), a = !(this.isAfterMinDate(s, !0, !1) === !1 || this.isBeforeMaxDate(s, !0, !1) === !1)
            } else {
                var s = e(this.currentDate);
                s.minute(t).second(0), a = !(this.isAfterMinDate(s, !0, !0) === !1 || this.isBeforeMaxDate(s, !0, !0) === !1)
            }
            return a
        },
        ...
        _onClearClick: function () {
            this.currentDate = null, this.$element.trigger("beforeChange", this.currentDate), this.hide(), "undefined" != typeof t.material && this.$element.addClass("empty"), this.$element.val(""), this.$element.trigger("change", this.currentDate)
        },
        _onNowClick: function () {
            if (this.currentDate = e(), this.params.date === !0 && (this.showDate(this.currentDate), 0 === this.currentView && this.initDate()), this.params.time === !0) {
        ...
        _onSelectDate: function (e) {
            this.$dtpElement.find("a.dtp-select-day").removeClass("selected"), t(e.currentTarget).addClass("selected"), this.selectDate(t(e.currentTarget).parent().data("date")), this.params.switchOnClick === !0 && this.params.time === !0 && setTimeout(this.initHours.bind(this), 200)
        },
        _onSelectHour: function (e) {
            if (!t(e.target).hasClass("disabled")) {
                for (var i = t(e.target).data("hour"), a = t(e.target).parent(), s = a.find(".dtp-select-hour"), n = 0; n < s.length; n++) t(s[n]).attr("fill", "transparent");
                for (var r = a.find(".dtp-select-hour-text"), n = 0; n < r.length; n++) t(r[n]).attr("fill", "#000");
                t(a.find("#h-" + i)).attr("fill", "#8BC34A"), t(a.find("#th-" + i)).attr("fill", "#fff"), this.currentDate.hour(parseInt(i)), this.params.shortTime === !0 && this.isPM() && this.currentDate.add(12, "hours"), this.showTime(this.currentDate), this.animateHands(), this.params.switchOnClick === !0 && setTimeout(this.initMinutes.bind(this), 200)
            }
        },
        _onSelectMinute: function (e) {
            if (!t(e.target).hasClass("disabled")) {
                for (var i = t(e.target).data("minute"), a = t(e.target).parent(), s = a.find(".dtp-select-minute"), n = 0; n < s.length; n++) t(s[n]).attr("fill", "transparent");
                for (var r = a.find(".dtp-select-minute-text"), n = 0; n < r.length; n++) t(r[n]).attr("fill", "#000");
                t(a.find("#m-" + i)).attr("fill", "#8BC34A"), t(a.find("#tm-" + i)).attr("fill", "#fff"), this.currentDate.minute(parseInt(i)), this.showTime(this.currentDate), this.animateHands(), this.params.switchOnClick === !0 && setTimeout(function () {
                    this.setElementValue(), this.hide()
                }.bind(this), 200)
            }
        },
        ...
        convertHours: function (t) {
            var e = t;
            return this.params.shortTime === !0 && 12 > t && this.isPM() && (e += 12), e
        },
        setDate: function (t) {
        ...
        show: function () {
            this.$dtpElement.removeClass("hidden"), this._attachEvent(t(window), "keydown", this._onKeydown.bind(this)), this._centerBox()
        },
        hide: function () {
            t(window).off("keydown", null, null, this._onKeydown.bind(this)), this.$dtpElement.addClass("hidden")
        },
        _centerBox: function () {
            var t = (this.$dtpElement.height() - this.$dtpElement.find(".dtp-content").height()) / 2;
            this.$dtpElement.find(".dtp-content").css("marginRight", -(this.$dtpElement.find(".dtp-content").width() / 2) + "px"), this.$dtpElement.find(".dtp-content").css("top", t + "px")
        }
    }
}(jQuery, moment);
